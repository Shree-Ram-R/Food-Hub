  ...
  return (
    ...
    <nav >
      ...
      <ul className="nav">
        ...
        <li><Link to="/Addcart" style={{ textDecoration: 'none',color: "black" }}> <p className="navIc"><span className={cart.length===0?"cartCount":"added"}>{cart.length}</span><FaCartArrowDown/>Add Cart</p></Link></li>
      </ul>
    </nav>
    <Routes>
      <Route path="/" element={<Home/>}/>
      <Route path="/Menu" element={<Menu cart={cart} setCart={setCart} resta={resta}/>}/>
